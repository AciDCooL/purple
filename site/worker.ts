...
<script type="application/ld+json">
{
  ...
  "featureList": [
    ...
    "Dedicated Keys tab for SSH key inspection and push: per-key strength score, randomart fingerprint, activity sparkline, linked-hosts view, multi-host push to your fleet with automatic skip for Vault-managed hosts",
    ...
    <div class="terminal">
      ...
      <div class="terminal-body">
        ...
        <div class="install-output" id="install-output" style="display:none">
          <div>Downloading purple v3.15.13 for darwin-arm64...</div>
...
<main class="content">
  ...
  <div class="features">
    ...
    <div class="feat">
      <span class="feat-icon">🗝️</span>
      <span class="feat-text"><strong>Push any SSH key to your fleet from one tab.</strong> Dedicated Keys page. Strength score, randomart fingerprint, encryption status and a per-key activity sparkline that auto-scales as your usage history grows. Press <code>p</code> to push the highlighted key to multiple hosts at once. Vault-managed hosts skip automatically so cert-managed hosts stay cert-managed. <code>Tab</code> from the Hosts page.</span>
    </div>
    <div class="feat">
      <span class="feat-icon">📂</span>
  ...
  <div class="faq">
    ...
    <div class="man-page">
      ...
      <div class="man-foot"><span>purple v3.15.13</span><span>2026-05-22</span><span>PURPLE(1)</span></div>
    </div>
  </div>
...
<footer>
  <a href="https://github.com/erickochen/purple" rel="noopener">GitHub</a> &middot; <a href="https://github.com/erickochen/purple/wiki" rel="noopener">Docs</a> &middot; <a href="https://crates.io/crates/purple-ssh" rel="noopener">crates.io</a> &middot; MIT License &middot; Rust &middot; 7300+ tests
</footer>
...
The primary interface is the TUI. Run purple to launch it. Press ? for the full keybindings cheat sheet. Press : to open Jump, a universal fuzzy search bar that finds any host, tunnel, container, snippet or action across your SSH config. The TUI has four top-level pages: Hosts (default), Tunnels (live overview of every SSH forward across all hosts), Containers (every Docker or Podman container across every host, grouped per host) and Keys (every SSH key in ~/.ssh/ with strength, randomart, activity sparkline and multi-host push). Press Tab to cycle between them. Most actions are available from the TUI: S for provider management, r for snippets, T for the per-host tunnel overlay, C for the per-host container overlay, F for file browser. The CLI subcommands below are alternatives for scripting and automation.
...
- Current version: 3.15.13 (May 2026)
- Release cadence: approximately bi-weekly
- Test suite: 8100+ tests (unit, integration, property-based, HTTP mocking and OpenSSH ground-truth cross-validation)
