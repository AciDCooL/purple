...
- vs. Lazydocker: Lazydocker manages Docker locally. purple manages Docker and Podman on remote servers over SSH. Use Lazydocker for single-host local management. Use purple for multi-host remote management
