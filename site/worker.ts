    ...
    <div class="terminal">
      ...
      <div class="terminal-body">
        ...
        <div class="install-output" id="install-output" style="display:none">
          <div>Downloading purple v3.14.0 for darwin-arm64...</div>
...
<main class="content">
  ...
  <div class="faq">
    ...
    <div class="man-page">
      ...
      <div class="man-foot"><span>purple v3.14.0</span><span>2026-05-16</span><span>PURPLE(1)</span></div>
    </div>
  </div>
...
- Current version: 3.14.0 (May 2026)
- Release cadence: approximately bi-weekly
- Test suite: 7300+ tests (unit, integration, property-based, HTTP mocking and OpenSSH ground-truth cross-validation)
