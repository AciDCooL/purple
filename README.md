...
**It doesn't break anything.** Comments, indentation, unknown directives. All preserved through every edit. Tested with 1063 tests including round-trip integration.
...
Rust. 1063 tests. Zero clippy warnings. No async runtime. Single binary.
